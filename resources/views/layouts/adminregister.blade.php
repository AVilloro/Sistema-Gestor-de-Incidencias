         ...
         <div class="header-container">
            <header class="header-wrapper">
               <div class="viu-logo">
                  ...
                  <img src="/images/logo.png" style="weight:90px; height:90px; margin-left:-70px; margin-top: 50px;">
               </div>
            </header>
         </div>
            ...
            <div class="signup-wrapper">
               ...
               <div class="signup-buttons">
                  <form class="form-horizontal form login" role="form" method="POST" action="{{ url('/register') }}">
                     ...
                     <button type="submit" class="form_field_register">
                     Regístrate
                     </button>
                     <a href="/admin" type="submit" class="goback">
                     Volver atrás
                     </a>
                  </form>
