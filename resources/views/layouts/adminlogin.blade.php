                ...
                <div class="signup-buttons">
                    <form class="form-horizontal form login" role="form" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form__field">
                            ...
                            <input id="email" type="text" class="form__input" name="email" placeholder="Email" value="{{ old('email') }}" required autofocus> @if ($errors->has('email'))
                        ...
                        <button type="submit" class="form_field">
                            Iniciar sesión
                        </button>
                    </form>
                    <p class="text--center">¿Aún no formas parte de nuestro equipo? <a href="/registers">Regístrate</a>
                        <svg class="icon">
